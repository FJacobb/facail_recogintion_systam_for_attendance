...
class Train_test():
    def __init__(self):
        super().__init__()
        self.train_test = Toplevel()
        self.train_test.title("Register")
        self.train_test.geometry("925x500+300+200")
        self.img3 = PhotoImage(file="./image_for_project/man.png")
        self.train_test.iconphoto(False, self.img3)
        self.background = PhotoImage(file="./image_for_project/background.png")
        Label(self.train_test, image=self.background).place(x=0, y=0)
        Label(self.train_test, text="Student Data Collection", fg="#2B65EC", bg="#fff",
              font=("Franklin Gothic Heavy", 28, "bold")).place(x=220, y=2)
        self.but()
        self.train_test.mainloop()
    ...
    def but(self):
        ...
        self.frame1 = Frame(self.train_test, width=350, height=350, bg="#446bb9")
        ...
        self.frame2 = Frame(self.train_test, width=350, height=350, bg="#446bb9")
    ...
    def facecollect(self):
        ...
        self.button_rg = Button(self.frame2, text="Verify Student ID", width=25, pady=7, bg="#fff", fg="#446bb9",
                                border=0,
                                command=check)
        self.button_rg.place(x=80, y=290)
        self.button_rg.bind("<Enter>", on_enter)
