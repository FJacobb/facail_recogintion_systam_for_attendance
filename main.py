...
def home_page():
    ...
    Label(home, text="Facial Recognition System", fg="#2B65EC", bg="#fff", font=("Franklin Gothic Heavy", 28, "bold")).place(x=180, y=2)
    ...
    Label(frame1, text="Verify User", fg="#fff", bg="#446bb9", font=("Franklin Gothic Heavy", 23, "bold")).place(x=80,y=110)
...
def login_pages():
    ...
    #############################################################################################################
    Button(frame, width=36, pady=7, text="Sign in", bg="#57a1f8", fg="#fff", border=0, command=signin).place(x=50,
                                                                                                             y=210)
